export const metadata = {
  ...
  description:
    "How Kettle River BI aligned Finance, Operations, Sales, and Warehouse at a Pacific Northwest packaged food manufacturer around one definition of loss and waste, driving a normalized 37.7% year-over-year reduction.",
...
const articleJsonLd = {
  ...
  description:
    "How Kettle River BI aligned Finance, Operations, Sales, and Warehouse at a Pacific Northwest packaged food manufacturer around one definition of loss and waste. Result: a normalized 37.7% year-over-year reduction, measured like for like with commodity movement and a one-time acquisition write-off excluded.",
  author: {
    "@type": "Organization",
